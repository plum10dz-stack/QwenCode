...
//  */
// import { SYNC_STATUS, QUEUE_OP, QUEUE_ENTRY_STATUS, SyncStatus, QueueOperation, QueueEntry } from '../../flow/types';
// import { getIdList, StockOS_CONFIG } from '../../flow/config'
// import { Row } from '../data/Row';
// import { ServerDB, Table } from '../../flow';
...
//   PONG: 'pong',
// }
// export class LocalDB extends Datasource<Row> {
//   async clearAll() {
...
//     throw new Error('Method not implemented.');
//   }
//   private _cfg: typeof StockOS_CONFIG;
//   private _db: IDBDatabase | undefined;
//   /** @param {StockOS_CONFIG} config */
//   constructor(config: typeof StockOS_CONFIG) {
//     super()
//     this._cfg = config
...
//    */
//   getIdList(tableName: string, row: any) {
...
//    */
//   async applyServerUpdates(tables: Table[], time: any) {
//     if (!tables) return;
...
//     const existing = await this.get(tableName, id)
//     if (!existing) return
//     const id_list = getIdList(tableName, existing)
//     const row: Row = {
//       ...existing,
//       deleted: true,
//       updated_at: this._now(),
...
//   }
//   // ── Read ──────────────────────────────────────────────────────────────────
//   async get(tableName: string, id: string): Promise<Row> {
...
//   async getAllRaw(tableName: string): Promise<Row[]> {
...
//       const rows = await this.getAllRaw(name)
...
//     });
//   }
//   _req<R extends Row | Row[]>(storeName: string, mode: "readonly" | "readwrite", fn: (store: IDBObjectStore) => IDBRequest): Promise<R> {
//     return new Promise((resolve, reject) => {
//       const tx = this._db!.transaction(storeName, mode)
//       const store = tx.objectStore(storeName)
//       const req = fn(store)
