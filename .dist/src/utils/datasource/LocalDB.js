...
class LocalDB extends Datasource_1.Datasource {
            ...
            for (const [tableName, tableData] of Object.entries(tables)) {
                ...
                const result = yield this._reqs(tableName, 'readwrite', (store) => {
                    for (const serverRow of rows) {
                        const localRow = Object.assign(Object.assign({}, serverRow), { syncStatus: types_1.SYNC_STATUS.SYNCED });
   ...
   */
    ...
    insert(tableName, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const row = Object.assign(Object.assign({}, data), { updated_at: this._now(), deleted: false, syncStatus: types_1.SYNC_STATUS.PENDING });
    ...
    update(tableName, id, changes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const row = Object.assign(Object.assign(Object.assign({}, existing), changes), { id, updated_at: this._now(), syncStatus: types_1.SYNC_STATUS.PENDING });
            yield this._idbPut(tableName, row);
    ...
    delete(tableName, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!existing)
                return;
            const id_list = (0, config_1.getIdList)(tableName, existing);
            const row = Object.assign(Object.assign({}, existing), { deleted: true, updated_at: this._now(), syncStatus: types_1.SYNC_STATUS.PENDING });
            yield this._idbPut(tableName, row);
    ...
    enqueue(operation, tableName, row) {
        return __awaiter(this, void 0, void 0, function* () {
            const entry = {
                ...
                retryCount: 0,
                status: types_1.QUEUE_ENTRY_STATUS.PENDING,
                error: null,
            };
    ...
    getPendingQueue() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return all
                .filter((e) => e.status === types_1.QUEUE_ENTRY_STATUS.PENDING ||
                e.status === types_1.QUEUE_ENTRY_STATUS.FAILED)
                .sort((a, b) => a.created_at.localeCompare(b.created_at));
        });
    }
    markQueueProcessing(entryId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._patchQueueEntry(entryId, { status: types_1.QUEUE_ENTRY_STATUS.PROCESSING });
        });
    }
    ...
    markQueueFailed(entryId, errorMsg) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!entry)
                return;
            yield this._idbPut('_queue', Object.assign(Object.assign({}, entry), { status: types_1.QUEUE_ENTRY_STATUS.FAILED, retryCount: entry.retryCount + 1, error: errorMsg }));
        });
    }
    /**
    ...
    flushQueue(serverDB) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const entry of entries) {
                ...
                yield this.setSyncStatus(entry.tableName, [entry.rowId], types_1.SYNC_STATUS.SYNCING);
                try {
                    let serverRow = null;
                    switch (entry.operation) {
                        case types_1.QUEUE_OP.INSERT:
                            serverRow = yield serverDB.create(entry.tableName, entry.data);
                            break;
                        case types_1.QUEUE_OP.UPDATE:
                            serverRow = yield serverDB.update(entry.tableName, entry.rowId, entry.data);
                            break;
                        case types_1.QUEUE_OP.DELETE:
                            yield serverDB.delete(entry.tableName, entry.rowId);
                            break;
                    }
                    if (serverRow) {
                        const reconciled = Object.assign(Object.assign({}, serverRow), { syncStatus: types_1.SYNC_STATUS.SYNCED });
                        yield this._idbPut(entry.tableName, reconciled);
                        this._emitChanged(entry.tableName, [reconciled], 'update');
                    }
                    else {
                        yield this.setSyncStatus(entry.tableName, [entry.rowId], types_1.SYNC_STATUS.SYNCED);
                    }
                    ...
                    yield this.setSyncStatus(entry.tableName, [entry.rowId], types_1.SYNC_STATUS.ERROR);
                }
            }
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const name in this._cfg.TABLES) {
                if (name.startsWith('_'))
                    continue;
                const rows = yield this.getAllRaw(name);
