...
function initEventsAPI(localDB, serverDB) {
    ...
    // ── Auth ──────────────────────────────────────────────────────────────────
    channels_1.swChannel.listenFor(config_1.DbEvents.AUTH_SET, (_a) => __awaiter(this, [_a], void 0, function* ({}) {
        if (localDB && serverDB) {
            serverDB.startPolling();
            yield localDB.flushQueue(serverDB);
        }
    }));
    channels_1.swChannel.listenFor(config_1.DbEvents.AUTH_CLEAR, () => __awaiter(this, void 0, void 0, function* () {
        serverDB === null || serverDB === void 0 ? void 0 : serverDB.stopPolling();
    }));
    // ── Ping ──────────────────────────────────────────────────────────────────
