 ...
 */
function getSyncCursor(localDB) {
    return __awaiter(this, void 0, void 0, function* () {
        const cached = yield localDB.keyValue(SYNC_CURSOR_CACHE_KEY);
        ...
        for (const tableName of config_1.TABLE_NAMES) {
 ...
 */
function setSyncCursor(localDB, tableName, time) {
    return __awaiter(this, void 0, void 0, function* () {
        const cursor = yield getSyncCursor(localDB);
...
function setTableLastTimeUpdate(localDB, tableName, time) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield setSyncCursor(localDB, tableName, time);
    });
}
...
function initialFullTableSync(localDB) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(`[sync] 🎉 Initial full-table sync complete. Total: ${totalRows} rows across ${tablesToSync.length} tables in ${totalDuration}ms.`);
    });
}
...
function auditEntriesToRows(entries) {
    return entries.map((e) => {
        ...
        return Object.assign(Object.assign({ id: e.row_id }, payload), { updated_at: e.created_at, deleted: false, syncStatus: data_1.SYNC_STATUS.SYNCED });
    });
}
