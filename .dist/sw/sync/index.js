...
__exportStar(require("./sync-live"), exports);
const services_1 = require("../services");
const db_init_1 = __importStar(require("./db-init"));
const sync_engine_1 = require("./sync-engine");
const sync_live_1 = require("./sync-live");
const utils_1 = require("../../utils");
const authenticator_1 = require("../../utils/networking/authenticator");
...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, db_init_1.default)();
        // Register channel-command handlers (read/write/flush etc.)
        (0, services_1.main)(db_init_1.DB.localDB, db_init_1.DB.serverDB);
        // ── AUTH events ───────────────────────────────────────────────────────────
        (0, utils_1.on)('AUTH', 'CONNECTED', (e) => __awaiter(this, void 0, void 0, function* () {
            console.info('[SW] AUTH.CONNECTED', e);
            (0, db_init_1.setAuth)(true);
            yield _onAuthConnected();
        }));
        (0, utils_1.on)('AUTH', 'DISCONNECTED', (e) => {
            console.info('[SW] AUTH.DISCONNECTED', e);
            (0, db_init_1.setAuth)(false);
            (0, sync_live_1.stopLiveSync)();
        });
        // ── Network events ────────────────────────────────────────────────────────
        self.addEventListener('online', () => __awaiter(this, void 0, void 0, function* () {
            console.info('[SW] Network online — flushing queue');
            yield db_init_1.DB.localDB.flushQueue(db_init_1.DB.serverDB).catch(err => console.warn('[SW] Queue flush on online failed:', err));
            if (!(0, sync_live_1.isLiveSyncRunning)())
                (0, sync_live_1.startLiveSync)();
        }));
        // ── Channel ───────────────────────────────────────────────────────────────
        utils_1.channels.swChannel.listenFor('PING', () => __awaiter(this, void 0, void 0, function* () {
...
function _onAuthConnected() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const alreadySynced = yield (0, sync_engine_1.hasInitialSyncRun)(db_init_1.DB.localDB);
            if (!alreadySynced) {
                console.info('[SW] No prior sync detected — running initial full-table sync…');
                yield (0, sync_engine_1.initialFullTableSync)(db_init_1.DB.localDB);
            }
        }
        catch (err) {
        ...
        yield db_init_1.DB.localDB.flushQueue(db_init_1.DB.serverDB).catch(err => console.warn('[SW] Queue flush on auth failed:', err));
...
function ensureInitialized() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        _initialized = true;
        init();
        utils_1.channels.swChannel.wait('CLOSE');
