 ...
 */
const db_init_1 = require("./sync/db-init");
...
function startLiveSync() {
    ...
    (() => __awaiter(this, void 0, void 0, function* () {
        ...
        while (running) {
            try {
                ...
                db_init_1.DB.serverDB.stopPolling();
                const since = (yield db_init_1.DB.localDB.getLastTimeUpdate()).getTime();
                abortCtrl = new AbortController();
                console.info('[SW] Audit-log stream connecting since', new Date(since).toISOString());
                const reason = yield (0, sync_engine_1.streamAuditLogSync)(db_init_1.DB.localDB, abortCtrl.signal, since, (table, count, cursor) => {
            ...
            db_init_1.DB.serverDB.startPolling();
    ...
    _liveSync = {
        stop() {
            ...
            db_init_1.DB.serverDB.stopStream();
            db_init_1.DB.serverDB.stopPolling();
        },
    };
}
