...
function _onAuthConnected() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const since = yield db_init_1.DB.localDB.getLastTimeUpdate();
            yield db_init_1.DB.serverDB.sync(since);
        }
        catch (err) {
